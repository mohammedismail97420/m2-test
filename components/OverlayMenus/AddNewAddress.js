  ...
  return (
    <div>
      <OverlayMenu>
        ...
        <h1 className="text-24 font-bold mt-10">Add New Address</h1>
        ...
        <div className="py-10 border-b-[1px] border-darkgray">
          <input
            className="mr-10"
            type="radio"
            name="defAddress"
            id="billing"
          />
          <label htmlFor="billing">Use as my default billing address</label>
        </div>
        <div className="py-10">
          <input
            className="mr-10"
            ...
            id="shipping"
          />
          <label htmlFor="shipping">Use as my default shipping address</label>
        </div>
